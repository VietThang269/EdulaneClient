...
function Register() {
  ...
  const onFinish = (values) => {
    if (values.isTeacher === "teacher") {
      values.isTeacher = true;
    } else {
      values.isTeacher = false;
    }
    const { userName, password, fullName, isTeacher, universityId } = values;
    register(
      {
        userName,
        password,
            ...
            >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Hãy nhập mã sinh viên hoặc giảng viên",
                  },
                ]}
              >
                <Input placeholder="Mã sinh viên hoặc giảng viên" />
              </Form.Item>
              <Form.Item
                name="isTeacher"
                rules={[
